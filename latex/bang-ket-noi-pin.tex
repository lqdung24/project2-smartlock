\begin{table}[H]
    ...
    \small
    \renewcommand{\arraystretch}{1.4} % Giãn dòng thoáng đãng, chuyên nghiệp
    \setlength{\tabcolsep}{5pt}      % Thu hẹp khoảng cách đệm giữa các cột để khít lề phải

    % Định nghĩa cột Y dựa trên X để tự động căn trái và xuống dòng cho các cột nhiều chữ
    \newcolumntype{Y}{>{\raggedright\arraybackslash}X}

    % Cấu hình hệ thống cột: 5 cột rõ ràng
...
% Cụm Camera (Đã sửa chính xác số lượng cột & và căn chỉnh thẳng hàng)
